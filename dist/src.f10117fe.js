...
function (_super) {
  ...
  UserList.prototype.renderItem = function (model, parent) {
    new UserShow_1.UserShow(parent, model).render();
  };
...
},{"./CollectionView":"src/views/CollectionView.ts","../views/UserShow":"src/views/UserShow.ts"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new Collection_1.Collection(rootUrl, User.buildUser);
  };
...
if (root) {
  var users_1 = new Collection_1.Collection('http://localhost:3000/users', function (json) {
    return User_1.User.buildUser(json);
  });
  users_1.on('change', function () {
    new UserList_1.UserList(root, users_1).render();
  });
  users_1.fetch();
}
